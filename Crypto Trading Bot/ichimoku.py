...
def fetch_binance_data(symbol="BTCUSDT", interval="1h", lookback="30 days ago UTC"): # NOTE: Why lookback 30 days? Also does it have to be 1h interval, I'd like to pop it down to 1m if possible
